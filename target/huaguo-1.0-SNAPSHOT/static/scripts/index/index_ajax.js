...
$(document).ready(function() {
		...
		/*var options = {
	      ...
	      container: $('#post-listing'), // Optional, used for some extra CSS styling
...
//						}
		...
		$('#sort_newest').click(function(){
			changeSortCss($(this.parentNode));
			
			if(params['sort'] == 'createDate'){
				if(params['order'] == 'desc'){
					params['order'] = 'asc';
					$(this).addClass('Upjian');
				}else{
					params['order'] = 'desc';
					$(this).addClass('DownJian');
				}
			}else{
				params['order'] = 'desc';
				$(this).addClass('DownJian');
